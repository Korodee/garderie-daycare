...
import { FaMapMarkerAlt, FaPhone, FaFax, FaEnvelope, FaClock, FaGlobe, FaHandPaper, FaPaperPlane } from "react-icons/fa";
...
const contactInfo = [
  ...
  },
  {
    ...
    label: "Courriel",
    value: "garderieaimee@hotmail.com",
...
export default function Contact() {
  return (
    <section id="contact" className=" bg-gradient-to-br from-indigo-50 via-blue-50 to-pink-50 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center my-20">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-100 text-indigo-900 font-semibold text-lg shadow mb-4">
          <FaHandPaper className="text-indigo-400 animate-wave" /> Toujours à l’écoute !
        </div>
        <p className="text-xl text-slate-700 max-w-2xl text-center mb-2">
          Contactez-nous pour toute question concernant nos services et l&apos;inscription de votre enfant.
        </p>
      </div>
      ...
      <div className="-mt-10 mb-12">
        <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-16">
          <path fill="url(#contact-wave)" d="M0,80 C360,160 1080,0 1440,80 L1440,120 L0,120 Z" />
          <defs>
            <linearGradient id="contact-wave" x1="0" x2="1440" y1="0" y2="0" gradientUnits="userSpaceOnUse">
      ...
      <div className="relative z-10 max-w-xl mx-auto mb-24">
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-10 shadow-2xl border-2 border-white/60 flex flex-col gap-8">
          {contactInfo.map((info, i) => (
            ...
            >
              ...
              <div className="flex-1">
                <div className="text-lg font-bold text-slate-800">{info.label}</div>
                <div className="text-xl font-extrabold text-indigo-600 mb-1">{info.value}</div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto mb-14">
        <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-10 shadow-2xl border-2 border-white/60 flex flex-col items-center">
          ...
          <h3 className="text-2xl font-bold mb-2 text-indigo-700">Notre Adresse</h3>
          <div className="text-lg font-semibold text-slate-800 mb-1">1730, rue Poirier</div>
          <div className="text-base text-slate-600 mb-2">Saint-Laurent (Québec) H4L 1J3</div>
      ...
      <div className="fixed bottom-8 right-8 z-50 hidden md:block">
        <a href="https://www.laplace0-5.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-gradient-to-r from-indigo-500 to-pink-500 text-white px-8 py-4 rounded-full font-bold shadow-2xl text-lg hover:scale-105 transition-transform animate-bounce-slow">
          <span className="text-2xl"><FaGlobe /></span>
